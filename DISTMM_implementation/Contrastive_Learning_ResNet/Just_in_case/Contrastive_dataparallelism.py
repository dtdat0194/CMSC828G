...
class ContrastiveLearning(nn.Module):
    ...
    def forward(self, video_data, spectrogram_data):
        # TODO: Implement forward pass
        video_data, spectrogram_data = self.Encoder(video_data,spectrogram_data)
        ...
        loss = self.info_nce_loss(video_data.to("cuda:0"),spectrogram_data.to("cuda:0"))
    ...
    def info_nce_loss(self, features_1, features_2):
        ...
        pos_mask_matrix = (labels.unsqueeze(1) == labels.t().unsqueeze(0)).float().to("cuda:0")
